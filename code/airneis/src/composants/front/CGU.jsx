...
const MentionLegale = () => {
    return ( <>
        ...
        <div className="container">
            ...
            <h4 className="cgu-title2">3 – EXACTITUDE, EXHAUSTIVITÉ ET ACTUALITÉ DES INFORMATIONS</h4>
            ...
            <h4 className="cgu-title2">5 – PRODUITS OU SERVICES (le cas échéant)</h4>
            ...
            <h4 className="cgu-title2">6 – EXACTITUDE DE LA FACTURATION ET DES INFORMATIONS DE COMPTE</h4>
            ...
            <h4 className="cgu-title2">9 – COMMENTAIRES, RETOURS D'EXPÉRIENCE ET AUTRES SOUMISSIONS</h4>
            ...
            <h4 className="cgu-title2">13 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ</h4>
            ...
            <h4 className="cgu-title2">19 – MODIFICATIONS APPORTÉES AUX CONDITIONS D’UTILISATION</h4>
