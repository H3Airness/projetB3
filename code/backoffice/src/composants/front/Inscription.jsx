...
function Inscription() {
  ...
  const handleSubmit = e => {
    ...
    async function postData() {
      try {
        const response = await axios.post('http://airneis.fr:3000/inscription.php', formType, {});
  ...
  return (
    ...
    <NavLink to="/" className={({isActive}) => {
      ...
      }}> <img className="logo-airneis-connexion" src="logo.svg" alt="" /><span className="titreConnexion">Àirneis</span>
    </NavLink>
    </div>
